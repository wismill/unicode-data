-- autogenerated from https://www.unicode.org/Public/18.0.0/security/intentional.txt
-- |
...
intentionalConfusables = \case
    ...
    'A' -> "\206\145\0"#
    'B' -> "\206\146\0"#
    'C' -> "\208\161\226\133\173\0"#
    'D' -> "\226\133\174\0"#
    'E' -> "\206\149\0"#
    'H' -> "\206\151\0"#
    'I' -> "\206\153\226\133\160\0"#
    'J' -> "\208\136\0"#
    'K' -> "\206\154\0"#
    'L' -> "\226\133\172\0"#
    'M' -> "\206\156\226\133\175\0"#
    'N' -> "\206\157\0"#
    'O' -> "\206\159\0"#
    'P' -> "\206\161\0"#
    'S' -> "\208\133\0"#
    'T' -> "\206\164\0"#
    'V' -> "\226\133\164\0"#
    'X' -> "\206\167\226\133\169\0"#
    'Y' -> "\206\165\0"#
    'Z' -> "\206\150\0"#
    'a' -> "\208\176\0"#
    'c' -> "\209\129\226\133\189\0"#
    'd' -> "\212\129\226\133\190\0"#
    'e' -> "\208\181\0"#
    'h' -> "\210\187\0"#
    'i' -> "\209\150\226\133\176\0"#
    'j' -> "\207\179\0"#
    'l' -> "\226\133\188\0"#
    'm' -> "\226\133\191\0"#
    'o' -> "\206\191\0"#
