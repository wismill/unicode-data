-- autogenerated from https://www.unicode.org/Public/18.0.0/ucd/Blocks.txt
-- |
...
--
-- There is a total of 354 blocks.
--
-- @since 0.3.1
data Block
    ...
    | Sidetic -- ^ @U+10940..U+1095F@: Sidetic.
    ...
    | SharadaSupplement -- ^ @U+11B60..U+11B7F@: Sharada Supplement.
    ...
    | TolongSiki -- ^ @U+11DB0..U+11DEF@: Tolong Siki.
    | BengaliSupplement -- ^ @U+11DF0..U+11DFF@: Bengali Supplement.
    ...
    | ArchaicCuneiformNumerals -- ^ @U+12550..U+1268F@: Archaic Cuneiform Numerals.
    ...
    | Chisoi -- ^ @U+16D80..U+16DAF@: Chisoi.
    | Medefaidrin -- ^ @U+16E40..U+16E9F@: Medefaidrin.
    | BeriaErfe -- ^ @U+16EA0..U+16EDF@: Beria Erfe.
    ...
    | TangutComponentsSupplement -- ^ @U+18D80..U+18DFF@: Tangut Components Supplement.
    | Jurchen -- ^ @U+18E00..U+1919F@: Jurchen.
    | JurchenRadicals -- ^ @U+191A0..U+191DF@: Jurchen Radicals.
    ...
    | MiscellaneousSymbolsSupplement -- ^ @U+1CEC0..U+1CEFF@: Miscellaneous Symbols Supplement.
    ...
    | MusicalSymbolsSupplement -- ^ @U+1D250..U+1D28F@: Musical Symbols Supplement.
    ...
    | MiscellaneousSymbolsAndArrowsExtended -- ^ @U+1DB00..U+1DBFF@: Miscellaneous Symbols and Arrows Extended.
    ...
    | CJKUnifiedIdeographsExtensionI -- ^ @U+2EBF0..U+2EE5F@: CJK Unified Ideographs Extension I.
    ...
    | CJKUnifiedIdeographsExtensionJ -- ^ @U+323B0..U+3347F@: CJK Unified Ideographs Extension J.
    | Seal -- ^ @U+3D000..U+3FC3F@: Seal.
...
-- | Block definition
--
-- Undefined for values greater than 353.
--
-- Returned value:
--
-- * Lower bound
...
blockDefinition = \case
    ...
    195# -> (# 0x10940#, 0x1095f#, "Sidetic\0"# #)
    196# -> (# 0x10980#, 0x1099f#, "Meroitic Hieroglyphs\0"# #)
    197# -> (# 0x109a0#, 0x109ff#, "Meroitic Cursive\0"# #)
    198# -> (# 0x10a00#, 0x10a5f#, "Kharoshthi\0"# #)
    199# -> (# 0x10a60#, 0x10a7f#, "Old South Arabian\0"# #)
    200# -> (# 0x10a80#, 0x10a9f#, "Old North Arabian\0"# #)
    201# -> (# 0x10ac0#, 0x10aff#, "Manichaean\0"# #)
    202# -> (# 0x10b00#, 0x10b3f#, "Avestan\0"# #)
    203# -> (# 0x10b40#, 0x10b5f#, "Inscriptional Parthian\0"# #)
    204# -> (# 0x10b60#, 0x10b7f#, "Inscriptional Pahlavi\0"# #)
    205# -> (# 0x10b80#, 0x10baf#, "Psalter Pahlavi\0"# #)
    206# -> (# 0x10c00#, 0x10c4f#, "Old Turkic\0"# #)
    207# -> (# 0x10c80#, 0x10cff#, "Old Hungarian\0"# #)
    208# -> (# 0x10d00#, 0x10d3f#, "Hanifi Rohingya\0"# #)
    209# -> (# 0x10d40#, 0x10d8f#, "Garay\0"# #)
    210# -> (# 0x10e60#, 0x10e7f#, "Rumi Numeral Symbols\0"# #)
    211# -> (# 0x10e80#, 0x10ebf#, "Yezidi\0"# #)
    212# -> (# 0x10ec0#, 0x10eff#, "Arabic Extended-C\0"# #)
    213# -> (# 0x10f00#, 0x10f2f#, "Old Sogdian\0"# #)
    214# -> (# 0x10f30#, 0x10f6f#, "Sogdian\0"# #)
    215# -> (# 0x10f70#, 0x10faf#, "Old Uyghur\0"# #)
    216# -> (# 0x10fb0#, 0x10fdf#, "Chorasmian\0"# #)
    217# -> (# 0x10fe0#, 0x10fff#, "Elymaic\0"# #)
    218# -> (# 0x11000#, 0x1107f#, "Brahmi\0"# #)
    219# -> (# 0x11080#, 0x110cf#, "Kaithi\0"# #)
    220# -> (# 0x110d0#, 0x110ff#, "Sora Sompeng\0"# #)
    221# -> (# 0x11100#, 0x1114f#, "Chakma\0"# #)
    222# -> (# 0x11150#, 0x1117f#, "Mahajani\0"# #)
    223# -> (# 0x11180#, 0x111df#, "Sharada\0"# #)
    224# -> (# 0x111e0#, 0x111ff#, "Sinhala Archaic Numbers\0"# #)
    225# -> (# 0x11200#, 0x1124f#, "Khojki\0"# #)
    226# -> (# 0x11280#, 0x112af#, "Multani\0"# #)
    227# -> (# 0x112b0#, 0x112ff#, "Khudawadi\0"# #)
    228# -> (# 0x11300#, 0x1137f#, "Grantha\0"# #)
    229# -> (# 0x11380#, 0x113ff#, "Tulu-Tigalari\0"# #)
    230# -> (# 0x11400#, 0x1147f#, "Newa\0"# #)
    231# -> (# 0x11480#, 0x114df#, "Tirhuta\0"# #)
    232# -> (# 0x11580#, 0x115ff#, "Siddham\0"# #)
    233# -> (# 0x11600#, 0x1165f#, "Modi\0"# #)
    234# -> (# 0x11660#, 0x1167f#, "Mongolian Supplement\0"# #)
    235# -> (# 0x11680#, 0x116cf#, "Takri\0"# #)
    236# -> (# 0x116d0#, 0x116ff#, "Myanmar Extended-C\0"# #)
    237# -> (# 0x11700#, 0x1174f#, "Ahom\0"# #)
    238# -> (# 0x11800#, 0x1184f#, "Dogra\0"# #)
    239# -> (# 0x118a0#, 0x118ff#, "Warang Citi\0"# #)
    240# -> (# 0x11900#, 0x1195f#, "Dives Akuru\0"# #)
    241# -> (# 0x119a0#, 0x119ff#, "Nandinagari\0"# #)
    242# -> (# 0x11a00#, 0x11a4f#, "Zanabazar Square\0"# #)
    243# -> (# 0x11a50#, 0x11aaf#, "Soyombo\0"# #)
    244# -> (# 0x11ab0#, 0x11abf#, "Unified Canadian Aboriginal Syllabics Extended-A\0"# #)
    245# -> (# 0x11ac0#, 0x11aff#, "Pau Cin Hau\0"# #)
    246# -> (# 0x11b00#, 0x11b5f#, "Devanagari Extended-A\0"# #)
    247# -> (# 0x11b60#, 0x11b7f#, "Sharada Supplement\0"# #)
    248# -> (# 0x11bc0#, 0x11bff#, "Sunuwar\0"# #)
    249# -> (# 0x11c00#, 0x11c6f#, "Bhaiksuki\0"# #)
    250# -> (# 0x11c70#, 0x11cbf#, "Marchen\0"# #)
    251# -> (# 0x11d00#, 0x11d5f#, "Masaram Gondi\0"# #)
    252# -> (# 0x11d60#, 0x11daf#, "Gunjala Gondi\0"# #)
    253# -> (# 0x11db0#, 0x11def#, "Tolong Siki\0"# #)
    254# -> (# 0x11df0#, 0x11dff#, "Bengali Supplement\0"# #)
    255# -> (# 0x11ee0#, 0x11eff#, "Makasar\0"# #)
    256# -> (# 0x11f00#, 0x11f5f#, "Kawi\0"# #)
    257# -> (# 0x11fb0#, 0x11fbf#, "Lisu Supplement\0"# #)
    258# -> (# 0x11fc0#, 0x11fff#, "Tamil Supplement\0"# #)
    259# -> (# 0x12000#, 0x123ff#, "Cuneiform\0"# #)
    260# -> (# 0x12400#, 0x1247f#, "Cuneiform Numbers and Punctuation\0"# #)
    261# -> (# 0x12480#, 0x1254f#, "Early Dynastic Cuneiform\0"# #)
    262# -> (# 0x12550#, 0x1268f#, "Archaic Cuneiform Numerals\0"# #)
    263# -> (# 0x12f90#, 0x12fff#, "Cypro-Minoan\0"# #)
    264# -> (# 0x13000#, 0x1342f#, "Egyptian Hieroglyphs\0"# #)
    265# -> (# 0x13430#, 0x1345f#, "Egyptian Hieroglyph Format Controls\0"# #)
    266# -> (# 0x13460#, 0x143ff#, "Egyptian Hieroglyphs Extended-A\0"# #)
    267# -> (# 0x14400#, 0x1467f#, "Anatolian Hieroglyphs\0"# #)
    268# -> (# 0x16100#, 0x1613f#, "Gurung Khema\0"# #)
    269# -> (# 0x16800#, 0x16a3f#, "Bamum Supplement\0"# #)
    270# -> (# 0x16a40#, 0x16a6f#, "Mro\0"# #)
    271# -> (# 0x16a70#, 0x16acf#, "Tangsa\0"# #)
    272# -> (# 0x16ad0#, 0x16aff#, "Bassa Vah\0"# #)
    273# -> (# 0x16b00#, 0x16b8f#, "Pahawh Hmong\0"# #)
    274# -> (# 0x16d40#, 0x16d7f#, "Kirat Rai\0"# #)
    275# -> (# 0x16d80#, 0x16daf#, "Chisoi\0"# #)
    276# -> (# 0x16e40#, 0x16e9f#, "Medefaidrin\0"# #)
    277# -> (# 0x16ea0#, 0x16edf#, "Beria Erfe\0"# #)
    278# -> (# 0x16f00#, 0x16f9f#, "Miao\0"# #)
    279# -> (# 0x16fe0#, 0x16fff#, "Ideographic Symbols and Punctuation\0"# #)
    280# -> (# 0x17000#, 0x187ff#, "Tangut\0"# #)
    281# -> (# 0x18800#, 0x18aff#, "Tangut Components\0"# #)
    282# -> (# 0x18b00#, 0x18cff#, "Khitan Small Script\0"# #)
    283# -> (# 0x18d00#, 0x18d7f#, "Tangut Supplement\0"# #)
    284# -> (# 0x18d80#, 0x18dff#, "Tangut Components Supplement\0"# #)
    285# -> (# 0x18e00#, 0x1919f#, "Jurchen\0"# #)
    286# -> (# 0x191a0#, 0x191df#, "Jurchen Radicals\0"# #)
    287# -> (# 0x1aff0#, 0x1afff#, "Kana Extended-B\0"# #)
    288# -> (# 0x1b000#, 0x1b0ff#, "Kana Supplement\0"# #)
    289# -> (# 0x1b100#, 0x1b12f#, "Kana Extended-A\0"# #)
    290# -> (# 0x1b130#, 0x1b16f#, "Small Kana Extension\0"# #)
    291# -> (# 0x1b170#, 0x1b2ff#, "Nushu\0"# #)
    292# -> (# 0x1bc00#, 0x1bc9f#, "Duployan\0"# #)
    293# -> (# 0x1bca0#, 0x1bcaf#, "Shorthand Format Controls\0"# #)
    294# -> (# 0x1cc00#, 0x1cebf#, "Symbols for Legacy Computing Supplement\0"# #)
    295# -> (# 0x1cec0#, 0x1ceff#, "Miscellaneous Symbols Supplement\0"# #)
    296# -> (# 0x1cf00#, 0x1cfcf#, "Znamenny Musical Notation\0"# #)
    297# -> (# 0x1d000#, 0x1d0ff#, "Byzantine Musical Symbols\0"# #)
    298# -> (# 0x1d100#, 0x1d1ff#, "Musical Symbols\0"# #)
    299# -> (# 0x1d200#, 0x1d24f#, "Ancient Greek Musical Notation\0"# #)
    300# -> (# 0x1d250#, 0x1d28f#, "Musical Symbols Supplement\0"# #)
    301# -> (# 0x1d2c0#, 0x1d2df#, "Kaktovik Numerals\0"# #)
    302# -> (# 0x1d2e0#, 0x1d2ff#, "Mayan Numerals\0"# #)
    303# -> (# 0x1d300#, 0x1d35f#, "Tai Xuan Jing Symbols\0"# #)
    304# -> (# 0x1d360#, 0x1d37f#, "Counting Rod Numerals\0"# #)
    305# -> (# 0x1d400#, 0x1d7ff#, "Mathematical Alphanumeric Symbols\0"# #)
    306# -> (# 0x1d800#, 0x1daaf#, "Sutton SignWriting\0"# #)
    307# -> (# 0x1db00#, 0x1dbff#, "Miscellaneous Symbols and Arrows Extended\0"# #)
    308# -> (# 0x1df00#, 0x1dfff#, "Latin Extended-G\0"# #)
    309# -> (# 0x1e000#, 0x1e02f#, "Glagolitic Supplement\0"# #)
    310# -> (# 0x1e030#, 0x1e08f#, "Cyrillic Extended-D\0"# #)
    311# -> (# 0x1e100#, 0x1e14f#, "Nyiakeng Puachue Hmong\0"# #)
    312# -> (# 0x1e290#, 0x1e2bf#, "Toto\0"# #)
    313# -> (# 0x1e2c0#, 0x1e2ff#, "Wancho\0"# #)
    314# -> (# 0x1e4d0#, 0x1e4ff#, "Nag Mundari\0"# #)
    315# -> (# 0x1e5d0#, 0x1e5ff#, "Ol Onal\0"# #)
    316# -> (# 0x1e6c0#, 0x1e6ff#, "Tai Yo\0"# #)
    317# -> (# 0x1e7e0#, 0x1e7ff#, "Ethiopic Extended-B\0"# #)
    318# -> (# 0x1e800#, 0x1e8df#, "Mende Kikakui\0"# #)
    319# -> (# 0x1e900#, 0x1e95f#, "Adlam\0"# #)
    320# -> (# 0x1ec70#, 0x1ecbf#, "Indic Siyaq Numbers\0"# #)
    321# -> (# 0x1ed00#, 0x1ed4f#, "Ottoman Siyaq Numbers\0"# #)
    322# -> (# 0x1ee00#, 0x1eeff#, "Arabic Mathematical Alphabetic Symbols\0"# #)
    323# -> (# 0x1f000#, 0x1f02f#, "Mahjong Tiles\0"# #)
    324# -> (# 0x1f030#, 0x1f09f#, "Domino Tiles\0"# #)
    325# -> (# 0x1f0a0#, 0x1f0ff#, "Playing Cards\0"# #)
    326# -> (# 0x1f100#, 0x1f1ff#, "Enclosed Alphanumeric Supplement\0"# #)
    327# -> (# 0x1f200#, 0x1f2ff#, "Enclosed Ideographic Supplement\0"# #)
    328# -> (# 0x1f300#, 0x1f5ff#, "Miscellaneous Symbols and Pictographs\0"# #)
    329# -> (# 0x1f600#, 0x1f64f#, "Emoticons\0"# #)
    330# -> (# 0x1f650#, 0x1f67f#, "Ornamental Dingbats\0"# #)
    331# -> (# 0x1f680#, 0x1f6ff#, "Transport and Map Symbols\0"# #)
    332# -> (# 0x1f700#, 0x1f77f#, "Alchemical Symbols\0"# #)
    333# -> (# 0x1f780#, 0x1f7ff#, "Geometric Shapes Extended\0"# #)
    334# -> (# 0x1f800#, 0x1f8ff#, "Supplemental Arrows-C\0"# #)
    335# -> (# 0x1f900#, 0x1f9ff#, "Supplemental Symbols and Pictographs\0"# #)
    336# -> (# 0x1fa00#, 0x1fa6f#, "Chess Symbols\0"# #)
    337# -> (# 0x1fa70#, 0x1faff#, "Symbols and Pictographs Extended-A\0"# #)
    338# -> (# 0x1fb00#, 0x1fbff#, "Symbols for Legacy Computing\0"# #)
    339# -> (# 0x20000#, 0x2a6df#, "CJK Unified Ideographs Extension B\0"# #)
    340# -> (# 0x2a700#, 0x2b73f#, "CJK Unified Ideographs Extension C\0"# #)
    341# -> (# 0x2b740#, 0x2b81f#, "CJK Unified Ideographs Extension D\0"# #)
    342# -> (# 0x2b820#, 0x2ceaf#, "CJK Unified Ideographs Extension E\0"# #)
    343# -> (# 0x2ceb0#, 0x2ebef#, "CJK Unified Ideographs Extension F\0"# #)
    344# -> (# 0x2ebf0#, 0x2ee5f#, "CJK Unified Ideographs Extension I\0"# #)
    345# -> (# 0x2f800#, 0x2fa1f#, "CJK Compatibility Ideographs Supplement\0"# #)
    346# -> (# 0x30000#, 0x3134f#, "CJK Unified Ideographs Extension G\0"# #)
    347# -> (# 0x31350#, 0x323af#, "CJK Unified Ideographs Extension H\0"# #)
    348# -> (# 0x323b0#, 0x3347f#, "CJK Unified Ideographs Extension J\0"# #)
    349# -> (# 0x3d000#, 0x3fc3f#, "Seal\0"# #)
    350# -> (# 0xe0000#, 0xe007f#, "Tags\0"# #)
    351# -> (# 0xe0100#, 0xe01ef#, "Variation Selectors Supplement\0"# #)
    352# -> (# 0xf0000#, 0xfffff#, "Supplementary Private Use Area-A\0"# #)
...
rangesBitmap = Ptr
    ...
    \\225\23\175\8\1\0\224\8\1\24\255\8\1\0\0\9\33\24\31\9\1\0\32\9\65\24\63\9\1\0\64\9\97\24\95\9\1\0\128\9\129\24\159\9\1\0\160\9\161\24\255\9\1\0\0\10\193\24\95\10\1\0\96\10\225\24\127\10\1\0\128\10\1\25\159\10\1\0\192\10\33\25\255\10\1\0\0\11\65\25\63\11\1\0\64\11\97\25\95\11\1\0\96\11\129\25\127\11\1\0\128\11\161\25\175\11\1\0\0\12\193\25\79\12\1\0\128\12\225\25\255\12\1\0\0\13\1\26\63\13\1\0\64\13\33\26\143\13\1\0\96\14\65\26\127\14\1\0\128\14\97\26\191\14\1\0\192\14\129\26\255\14\1\0\0\15\161\26\47\15\1\0\48\15\193\26\111\15\1\0\112\15\225\26\175\15\1\0\176\15\1\27\223\15\1\0\224\15\33\27\255\15\1\0\0\16\65\27\127\16\1\0\128\16\97\27\207\16\1\0\208\16\129\27\255\16\1\0\0\17\161\27\79\17\1\0\80\17\193\27\127\17\1\0\128\
    \\17\225\27\223\17\1\0\224\17\1\28\255\17\1\0\0\18\33\28\79\18\1\0\128\18\65\28\175\18\1\0\176\18\97\28\255\18\1\0\0\19\129\28\127\19\1\0\128\19\161\28\255\19\1\0\0\20\193\28\127\20\1\0\128\20\225\28\223\20\1\0\128\21\1\29\255\21\1\0\0\22\33\29\95\22\1\0\96\22\65\29\127\22\1\0\128\22\97\29\207\22\1\0\208\22\129\29\255\22\1\0\0\23\161\29\79\23\1\0\0\24\193\29\79\24\1\0\160\24\225\29\255\24\1\0\0\25\1\30\95\25\1\0\160\25\33\30\255\25\1\0\0\26\65\30\79\26\1\0\80\26\97\30\175\26\1\0\176\26\129\30\191\26\1\0\192\26\161\30\255\26\1\0\0\27\193\30\95\27\1\0\96\27\225\30\127\27\1\0\192\27\1\31\255\27\1\0\0\28\33\31\111\28\1\0\112\28\65\31\191\28\1\0\0\29\97\31\95\29\1\0\96\29\129\31\175\29\1\0\176\29\161\31\239\29\1\0\240\29\193\31\255\29\1\0\
    \\224\30\225\31\255\30\1\0\0\31\1\32\95\31\1\0\176\31\33\32\191\31\1\0\192\31\65\32\255\31\1\0\0\32\97\32\255\35\1\0\0\36\129\32\127\36\1\0\128\36\161\32\79\37\1\0\80\37\193\32\143\38\1\0\144\47\225\32\255\47\1\0\0\48\1\33\47\52\1\0\48\52\33\33\95\52\1\0\96\52\65\33\255\67\1\0\0\68\97\33\127\70\1\0\0\97\129\33\63\97\1\0\0\104\161\33\63\106\1\0\64\106\193\33\111\106\1\0\112\106\225\33\207\106\1\0\208\106\1\34\255\106\1\0\0\107\33\34\143\107\1\0\64\109\65\34\127\109\1\0\128\109\97\34\175\109\1\0\64\110\129\34\159\110\1\0\160\110\161\34\223\110\1\0\0\111\193\34\159\111\1\0\224\111\225\34\255\111\1\0\0\112\1\35\255\135\1\0\0\136\33\35\255\138\1\0\0\139\65\35\255\140\1\0\0\141\97\35\127\141\1\0\128\141\129\35\255\141\1\0\0\142\161\35\159\145\1\0\160\145\193\35\223\145\1\
    \\0\240\175\225\35\255\175\1\0\0\176\1\36\255\176\1\0\0\177\33\36\47\177\1\0\48\177\65\36\111\177\1\0\112\177\97\36\255\178\1\0\0\188\129\36\159\188\1\0\160\188\161\36\175\188\1\0\0\204\193\36\191\206\1\0\192\206\225\36\255\206\1\0\0\207\1\37\207\207\1\0\0\208\33\37\255\208\1\0\0\209\65\37\255\209\1\0\0\210\97\37\79\210\1\0\80\210\129\37\143\210\1\0\192\210\161\37\223\210\1\0\224\210\193\37\255\210\1\0\0\211\225\37\95\211\1\0\96\211\1\38\127\211\1\0\0\212\33\38\255\215\1\0\0\216\65\38\175\218\1\0\0\219\97\38\255\219\1\0\0\223\129\38\255\223\1\0\0\224\161\38\47\224\1\0\48\224\193\38\143\224\1\0\0\225\225\38\79\225\1\0\144\226\1\39\191\226\1\0\192\226\33\39\255\226\1\0\208\228\65\39\255\228\1\0\208\229\97\39\255\229\1\0\192\230\129\39\255\230\1\0\224\231\161\39\255\231\1\0\0\232\193\39\223\232\
    \\1\0\0\233\225\39\95\233\1\0\112\236\1\40\191\236\1\0\0\237\33\40\79\237\1\0\0\238\65\40\255\238\1\0\0\240\97\40\47\240\1\0\48\240\129\40\159\240\1\0\160\240\161\40\255\240\1\0\0\241\193\40\255\241\1\0\0\242\225\40\255\242\1\0\0\243\1\41\255\245\1\0\0\246\33\41\79\246\1\0\80\246\65\41\127\246\1\0\128\246\97\41\255\246\1\0\0\247\129\41\127\247\1\0\128\247\161\41\255\247\1\0\0\248\193\41\255\248\1\0\0\249\225\41\255\249\1\0\0\250\1\42\111\250\1\0\112\250\33\42\255\250\1\0\0\251\65\42\255\251\1\0\0\0\98\42\223\166\2\0\0\167\130\42\63\183\2\0\64\183\162\42\31\184\2\0\32\184\194\42\175\206\2\0\176\206\226\42\239\235\2\0\240\235\2\43\95\238\2\0\0\248\34\43\31\250\2\0\0\0\67\43\79\19\3\0\80\19\99\43\175\35\3\0\176\35\131\43\127\52\3\0\0\208\163\43\63\252\3\0\0\0\206\43\127\
    \\0\14\0\0\1\238\43\239\1\14\0\0\0\15\44\255\255\15\0\0\0\48\44\255\255\16\0"#
